...
export const BehaviorTreeCompilerTarget = new Juke.Target({
  inputs: [
    ...
    'code/__DEFINES/**/*.dm',
    'tools/build_bt.py',
    'troutstation/**/*.bt.json', // Troutstation edit
  ],
  outputs: () => {
    return (Juke.glob('code/**/*.bt.json').concat(
    Juke.glob('troutstation/**/*.bt.json'))).map((file) => {
...
export const BuildTarget = new Juke.Target({
  dependsOn: [CombineChangelogsTarget, TguiTarget, TgFontTarget, DmTarget],
});
...
export const TgsTarget = new Juke.Target({
  dependsOn: [CombineChangelogsTarget, TguiTarget, TgFontTarget],
  executes: async () => {
